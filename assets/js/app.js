!(function (t, e) {
      ...
      (r = at.tokenize =
        function (t, e) {
          ...
          for (a = t, l = [], u = n.preFilter; a; ) {
            ...
            (s = W.exec(a)) &&
              ((i = s.shift()),
              o.push({ value: i, type: s[0].replace(H, " ") }),
              (a = a.slice(i.length))),
            n.filter))
              !(s = U[r].exec(a)) ||
                (u[r] && !(s = u[r](s))) ||
  ...
  (function (t, e) {
    ...
    y("popover", $t);
    const Mt = { offset: 10, method: "auto", target: "" },
  ...
  (function (t, e) {
    ...
    var Oe = (function (t) {
      ...
      return (
        ...
        (a.tweenFromTo = function (t, e, i) {
          return this.tweenTo(e, S({ startAt: { time: R(this, t) } }, i));
        }),
        (a.recent = function () {
          return this._recent;
        }),
    ...
    S(Oe.prototype, { _lock: 0, _hasPause: 0, _forcing: 0 });
    var Me,
        ...
        function s(e, n, s, r) {
          ...
          if (
            ...
            if (
              ((n = u.vars),
              (d = u.timeline =
                new Oe({ data: "nested", defaults: F || {} })).kill(),
              (d.parent = i(u)),
              A)
            )
              S(d.vars.defaults, { ease: "none" }),
    ...
    var In,
      ...
      jn = {
        ...
        core: { _removeProperty: Ti, _getMatrix: Mi },
      };
      ...
      return (
        ...
        r(p, function (e) {
          ...
          ((e.addEventListener && o && !i.found) || !o) &&
            (e.addEventListener(t, f, d), i.all.push({ eventName: t, fn: f }));
        }),
        f
      );
    }
        ...
        return (
          n(t, [
            ...
            },
            {
              ...
              value: function (t, e) {
                var i = this,
                  n = o({ descPosition: e.descPosition }, this.defaults);
                if (S(t) && !C(t)) {
                  A(t, "type") ||
...
function section_system() {
  ...
  function p(t) {
    switch (e.section_animation) {
      ...
      case "fade":
        "next" == t &&
          (u.set(i.eq(s), { zIndex: 2 }),
          u.set(i.eq(n), { zIndex: 0 }),
          u.to(i.eq(n), {
            ease: e.section_animation_ease,
            duration: e.section_animation_duration,
            opacity: 0,
          ...
          "prev" == t &&
            (l.set(i.eq(s), { zIndex: 2 }),
            l.set(i.eq(n), { zIndex: 0 }),
            l.to(i.eq(n), {
              ease: e.section_animation_ease,
              duration: e.section_animation_duration,
              opacity: 0,
      ...
      case "stack":
        "next" == t &&
          (u.set(i, { zIndex: 0 }),
          u.set(i.eq(n), { zIndex: 1 }),
          u.set(i.eq(s), { zIndex: 2, y: "100%" }),
          u.to(i.eq(s), {
            ease: e.section_animation_ease,
            duration: e.section_animation_duration,
            y: "0%",
          ...
          "prev" == t &&
            (l.set(i, { zIndex: 0 }),
            l.set(i.eq(n), { zIndex: 1 }),
            l.set(i.eq(s), { zIndex: 2, y: "-100%" }),
            l.to(i.eq(s), {
              ease: e.section_animation_ease,
              duration: e.section_animation_duration,
              y: "0%",
      ...
      case "parallax":
        "next" == t &&
          (u.set(i.eq(s), { y: "100%", opacity: 1, zIndex: 2 }),
          u.set(i.eq(n), { zIndex: 0 }),
          u.to(i.eq(n), {
            ease: e.section_animation_ease,
            duration: e.section_animation_duration,
          ...
          "prev" == t &&
            (l.set(i.eq(s), { y: "-100%", opacity: 1, zIndex: 2 }),
            l.set(i.eq(n), { zIndex: 0 }),
            l.to(i.eq(n), {
              ease: e.section_animation_ease,
              duration: e.section_animation_duration,
  ...
  !(function () {
    ...
    (function () {
      switch (e.section_animation) {
        case "slide":
          gsap.set(i, { y: "-100%" }), gsap.set(i.eq(n), { y: "0%" });
          break;
        case "fade":
          gsap.set(i, { opacity: 0, zIndex: 0 }),
            gsap.set(i.eq(n), { opacity: 1, zIndex: 2 });
          break;
        case "stack":
          gsap.set(i, { y: "100%" }), gsap.set(i.eq(n), { y: "0%" });
          break;
        case "parallax":
          gsap.set(i, { y: "-100%", zIndex: 2 }),
            gsap.set(i.eq(n), { y: "0%", zIndex: 0 });
          break;
        case "scale":
          gsap.set(i, { y: "-100%", zIndex: 2, scale: 1 }),
            gsap.set(i.eq(n), { y: "0%", zIndex: 0 });
          break;
        default:
          console.log(
  ...
  $("#contact-form").submit(function (t) {
    ...
    for (var e = $(this).serializeArray(), i = e.length, n = 0; n < i; n++)
      ...
      $("#contact-form input[name='" + e[n].name + "']").attr(
        ...
        ? e.push({ name: e[n].name + "_required", value: !0 })
        : e.push({ name: e[n].name + "_required", value: !1 });
    $.ajax({
      type: "POST",
      ...
      (function () {
        for (var t = -s / 2; t < i + s; t += s) {
          ...
          for (var e = -s / 2; e < n + s; e += s)
            t == -s / 2 && h++,
              p.push(new g({ x: ~~(t + m(-o, o)), y: ~~(e + m(-o, o)) }));
        }
      })(),
